...
public class InSideObject {
	@OEMRelatedColumns({ @OEMColumn(location = 6, sheetId = 2, title = "我只映射一个sheet，sheetId=2") })
	Integer integer;

	@OEMRelatedColumns({ @OEMColumn(location = 9, sheetId = 1, title = "我是一个内部，映射多个sheet，我在sheetId=1的表单中,location=9"), 
